...
1. `styled-components`の`theme`の導入

    - [theme.ts](https://github.com/dekihi-app/TypeScriptReactNextJsStudy/blob/main/src/next-sample/theme.ts)を追加
    - [_app.tsx](https://github.com/dekihi-app/TypeScriptReactNextJsStudy/blob/main/src/next-sample/pages/_app.tsx)に、`ThemeProvider`を追加
